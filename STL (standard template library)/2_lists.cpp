/*this is list, just change the name from vector to list*/
#include<iostream>
#include<list>
using namespace std;

int main(){
    list<int> v= {5,8,4,7,6}; /*how we declare vector*/
    v.push_back(20);
    v.push_back(30); /*will add the value at the end of the list*/

    v.pop_back(); /*removes the last element*/

    /*there are 2 ways to iterate through this, for each loop or by using an iterator*/

    cout<<"list traversing through iterator: "<<endl;
    list<int>::iterator itr; /*now this itr is actually a pointer so when we print it we dereference it*/
    ...
    cout<<"list traversing through for each loop: "<<endl;
